...
function theme_add_bootstrap() {
	wp_enqueue_style( 'prof_style', get_stylesheet_directory_uri() . '/style.css', array('bootstrap-css'), time());
...
add_action( 'init', 'add_prof_achievements' );
function add_prof_achievements() {
	$labels = array(
		'name'               => _x( 'Достижения', 'post type general name', 'wordpress' ),
		'singular_name'      => _x( 'Достижение', 'post type singular name', 'wordpress' ),
		'menu_name'          => _x( 'Все Достижения', 'admin menu', 'wordpress' ),
		'name_admin_bar'     => _x( 'Достижение', 'add new on admin bar', 'wordpress' ),
		'add_new'            => _x( 'Добавить Достижение', 'bio', 'wordpress' ),
		'add_new_item'       => __( 'Добавить Достижение', 'wordpress' ),
		'new_item'           => __( 'Новое Достижение', 'wordpress' ),
		'edit_item'          => __( 'Редактировать', 'wordpress' ),
		'view_item'          => __( 'Просмотреть', 'wordpress' ),
		'all_items'          => __( 'Все Достижения', 'wordpress' )
	);
